              ...
              >
                ...
                <div className="inline-flex items-center">
                  ...
                  <label className="mt-px cursor-pointer select-none font-light text-gray-700">
                    <p className="flex items-center font-sans text-sm font-normal leading-normal text-red-400 antialiased">
                      I agree the
                      <Link
                        to="/term"
                ...
                <button className="mt-6 block w-full select-none rounded-lg bg-gradient-to-r from-[#de09c2] to-[#00FFE1] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                  Register
                </button>
                <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-white antialiased">
                  ...
                  <Link
                    to="/login"
                    className="font-medium ml-2 text-orange-600 transition-colors hover:text-blue-700"
                  >
                    Sign In
                  </Link>
                </p>
